...
export const unwrapWholeParagraphEmphasis = {
    id: "MD-AI040",
    name: "Unwrap whole-paragraph emphasis",
    category: "emphasis",
    severity: "medium",
    description: "Remove ** or * that wraps an entire paragraph. Decorative weight that costs tokens without adding meaning. Inline emphasis is preserved.",
    run(text) {
            ...
            diagnostics: [
                {
                    ...
                    detail: "Whole-paragraph emphasis is decorative — the entire paragraph carries the same visual weight, so the marker conveys no information.",
                    occurrences,
                    charsSaved: saved,
                    sampleBefore: sample
                        ? sample.length > 50
...
// the pattern.
export const flagBoldLabels = {
    id: "MD-AI041",
    name: "Flag bold-label decorators",
    category: "emphasis",
    severity: "low",
    description: "Identify paragraphs that begin with a bold label like '**Note:**' or '**Warning:**'. Common pattern; flagged for visibility, not auto-fixed.",
    run(text) {
            ...
            diagnostics: [
                {
                    ...
                    detail: "Each costs 4 tokens for the asterisks. Consider whether the label could be a heading, a one-word lead-in without bold, or simply omitted in AI-target docs.",
