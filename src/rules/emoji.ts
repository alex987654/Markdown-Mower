...
export const reportEmojiDensity: Rule = {
  id: "MD-AI110",
  name: "Report emoji density",
  category: "emoji",
  severity: "low",
  description:
    "Count emoji per 1,000 characters. High density suggests decorative use that tokenizes expensively (2-4 tokens per emoji).",
  run(text): RuleResult {
    // Permissive emoji match — includes most pictographic Unicode blocks.
    const re =
      /[\u{1F300}-\u{1FAFF}\u{2600}-\u{27BF}\u{1F000}-\u{1F02F}\u{1F0A0}-\u{1F0FF}\u{2700}-\u{27BF}]/gu;
      ...
      diagnostics: [
        {
          ...
          message,
          detail:
            "Most emojis tokenize as 2-4 tokens each in English BPE vocabularies (more in tokenizers without a dedicated emoji vocab). Inline emoji carrying semantic meaning (✅ ⚠️ ❌) are usually worth keeping; emoji used as decoration usually aren't.",
